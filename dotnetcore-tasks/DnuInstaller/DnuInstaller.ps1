...
try {
    ...
    [string]$baseDirectory = Get-VstsInput -Name BaseDirectory
    ...
    {
        $path = Get-TaskVariable $distributedTaskContext "System.DefaultWorkingDirectory"    
    }    
    ...
    Get-ChildItem -Path $path\src -Filter project.json -Recurse | ForEach-Object { & dnu restore $_.FullName 2>1 }   
} finally {
